...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, PWSTR, int show_command) {
    ...
    while (true) {
        ...
        // The current Null RHI does not present pixels yet. This loop validates
        // the Windows application boundary and leaves the renderer ready for the
        // native D3D12/Vulkan swapchain stage.
        Sleep(1);
    }
}
